...
#define S_FUNCTION_NAME FORCESPRONLPsolver_simulinkBlockcompact
...
#include "../include/FORCESPRONLPsolver.h" 
#include "../include/FORCESPRONLPsolver_memory.h" 
...
extern solver_int32_default FORCESPRONLPsolver_adtool2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
FORCESPRONLPsolver_extfunc pt2function_FORCESPRONLPsolver = &FORCESPRONLPsolver_adtool2forces;
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 9, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    static FORCESPRONLPsolver_params params;
    static FORCESPRONLPsolver_output output;
    static FORCESPRONLPsolver_info info;
    static FORCESPRONLPsolver_mem * mem;
    ...
    #if SET_PRINTLEVEL_FORCESPRONLPsolver > 0
    ...
    if (mem == NULL)
    {
        mem = FORCESPRONLPsolver_internal_mem(0);
    }

    /* Call solver */
    solver_exitflag = FORCESPRONLPsolver_solve(&params, &output, &info, mem, fp , pt2function_FORCESPRONLPsolver);
