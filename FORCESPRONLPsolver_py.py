...
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
   ...
   OUTPUT = FORCESPRONLPsolver_py.FORCESPRONLPsolver_solve(PARAMS) solves a multistage problem
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - matrix of size [9x1]
       PARAMS['xinit'] - matrix of size [2x1]
       PARAMS['all_parameters'] - matrix of size [9x1]

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['u0'] - scalar

   [OUTPUT, EXITFLAG] = FORCESPRONLPsolver_py.FORCESPRONLPsolver_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESPRONLPsolver_py.FORCESPRONLPsolver_solve(PARAMS) returns 
...
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESPRONLPsolver/lib/FORCESPRONLPsolver_withModel.dll'))
    csolver = getattr(_lib,'FORCESPRONLPsolver_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESPRONLPsolver/lib/libFORCESPRONLPsolver_withModel.dll'))
    csolver = getattr(_lib,'FORCESPRONLPsolver_solve')

internal_mem = getattr(_lib,'FORCESPRONLPsolver_internal_mem')

class FORCESPRONLPsolver_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
    _fields_ = [('x0', ctypes.c_double * 9),
('xinit', ctypes.c_double * 2),
('all_parameters', ctypes.c_double * 9),
]

FORCESPRONLPsolver_params = {'x0' : np.array([]),
'xinit' : np.array([]),
...
FORCESPRONLPsolver_params_types = {'x0' : np.float64,
'xinit' : np.float64,
'all_parameters' : np.float64,
}

class FORCESPRONLPsolver_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESPRONLPsolver_outputs = {'u0' : np.array([]),
}


class FORCESPRONLPsolver_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FORCESPRONLPsolver_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FORCESPRONLPsolver_params_ctypes), ctypes.POINTER(FORCESPRONLPsolver_outputs_ctypes), ctypes.POINTER(FORCESPRONLPsolver_info), ctypes.POINTER(FORCESPRONLPsolver_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FORCESPRONLPsolver_mem)

def FORCESPRONLPsolver_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESPRONLPsolver_params_ctypes()
    for par in params_arg:
        ...
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESPRONLPsolver_params_types[par], requirements='F')
    ...
    outputs_py = FORCESPRONLPsolver_outputs_ctypes()
    info_py = FORCESPRONLPsolver_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESPRONLPsolver_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FORCESPRONLPsolver_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESPRONLPsolver_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FORCESPRONLPsolver_adtool2forces)
            else:
                exitflag = _lib.FORCESPRONLPsolver_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FORCESPRONLPsolver_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESPRONLPsolver_outputs:
        FORCESPRONLPsolver_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESPRONLPsolver_outputs,int(exitflag),info_py

solve = FORCESPRONLPsolver_solve
